...
contract Validation {
    ...
    struct Certificate {
        string Given_name;
        string Family_name;
        uint16 National_identification_number;
    ...
    function generateCertificate( 
        ...
        uint16 _National_identification_number,
    ...
    function getData(string memory _id) public view returns(string memory, string memory, uint16, string memory, string memory, string memory, string memory) {
        bytes32 byte_id = stringToBytes32(_id);
